...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,uid,role,lastName,const DeepCollectionEquality().hash(image),nationality,phoneNumber,description,address,birthAddress,church,beleifInGod,prayerNetwork,definitionOfGod,godsCalling,recommendation,fcmToken);
...
@useResult
$Res call({
 String name, String uid, UserRole role, String? lastName, List<int>? image, String? nationality, String? phoneNumber, String? description, String? address, String? birthAddress, String? church, String? beleifInGod, String? prayerNetwork, String? definitionOfGod, String? godsCalling, String? recommendation, String? fcmToken
});
...
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.name,_that.uid,_that.role,_that.lastName,_that.image,_that.nationality,_that.phoneNumber,_that.description,_that.address,_that.birthAddress,_that.church,_that.beleifInGod,_that.prayerNetwork,_that.definitionOfGod,_that.godsCalling,_that.recommendation,_that.fcmToken);case _:
  return orElse();
...
switch (_that) {
case _UserModel():
return $default(_that.name,_that.uid,_that.role,_that.lastName,_that.image,_that.nationality,_that.phoneNumber,_that.description,_that.address,_that.birthAddress,_that.church,_that.beleifInGod,_that.prayerNetwork,_that.definitionOfGod,_that.godsCalling,_that.recommendation,_that.fcmToken);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,uid,role,lastName,const DeepCollectionEquality().hash(_image),nationality,phoneNumber,description,address,birthAddress,church,beleifInGod,prayerNetwork,definitionOfGod,godsCalling,recommendation,fcmToken);
