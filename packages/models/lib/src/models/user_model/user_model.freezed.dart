...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,name,uid,email,const DeepCollectionEquality().hash(roles),isPublic,createdAt,lastName,const DeepCollectionEquality().hash(image),nationality,phoneNumber,description,address,birthAddress,church,beleifInGod,prayerNetwork,definitionOfGod,godsCalling,recommendation,fcmToken]);

@override
String toString() {
  return 'UserModel(name: $name, uid: $uid, email: $email, roles: $roles, isPublic: $isPublic, createdAt: $createdAt, lastName: $lastName, image: $image, nationality: $nationality, phoneNumber: $phoneNumber, description: $description, address: $address, birthAddress: $birthAddress, church: $church, beleifInGod: $beleifInGod, prayerNetwork: $prayerNetwork, definitionOfGod: $definitionOfGod, godsCalling: $godsCalling, recommendation: $recommendation, fcmToken: $fcmToken)';
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String uid,  String email,  Map<String, UserRole> roles,  bool isPublic, @TimestampConverter()  DateTime createdAt,  String? lastName,  List<int>? image,  String? nationality,  String? phoneNumber,  String? description,  String? address,  String? birthAddress,  String? church,  String? beleifInGod,  String? prayerNetwork,  String? definitionOfGod,  String? godsCalling,  String? recommendation,  String? fcmToken)  $default,) {final _that = this;
switch (_that) {
case _UserModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String uid,  String email,  Map<String, UserRole> roles,  bool isPublic, @TimestampConverter()  DateTime createdAt,  String? lastName,  List<int>? image,  String? nationality,  String? phoneNumber,  String? description,  String? address,  String? birthAddress,  String? church,  String? beleifInGod,  String? prayerNetwork,  String? definitionOfGod,  String? godsCalling,  String? recommendation,  String? fcmToken)?  $default,) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.name,_that.uid,_that.email,_that.roles,_that.isPublic,_that.createdAt,_that.lastName,_that.image,_that.nationality,_that.phoneNumber,_that.description,_that.address,_that.birthAddress,_that.church,_that.beleifInGod,_that.prayerNetwork,_that.definitionOfGod,_that.godsCalling,_that.recommendation,_that.fcmToken);case _:
  return null;
...
class _UserModel implements UserModel {
  const _UserModel({required this.name, required this.uid, required this.email, final  Map<String, UserRole> roles = const {}, this.isPublic = false, @TimestampConverter() required this.createdAt, this.lastName, final  List<int>? image, this.nationality, this.phoneNumber, this.description, this.address, this.birthAddress, this.church, this.beleifInGod, this.prayerNetwork, this.definitionOfGod, this.godsCalling, this.recommendation, this.fcmToken}): _roles = roles,_image = image;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,name,uid,email,const DeepCollectionEquality().hash(_roles),isPublic,createdAt,lastName,const DeepCollectionEquality().hash(_image),nationality,phoneNumber,description,address,birthAddress,church,beleifInGod,prayerNetwork,definitionOfGod,godsCalling,recommendation,fcmToken]);
...
/// Create a copy of UserModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? uid = null,Object? email = null,Object? roles = null,Object? isPublic = null,Object? createdAt = null,Object? lastName = freezed,Object? image = freezed,Object? nationality = freezed,Object? phoneNumber = freezed,Object? description = freezed,Object? address = freezed,Object? birthAddress = freezed,Object? church = freezed,Object? beleifInGod = freezed,Object? prayerNetwork = freezed,Object? definitionOfGod = freezed,Object? godsCalling = freezed,Object? recommendation = freezed,Object? fcmToken = freezed,}) {
