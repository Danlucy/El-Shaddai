...
import 'package:web/core/router/no_internet_screen.dart';

import 'package:web/core/router/router.dart';
import 'package:web/features/auth/controller/auth_controller.dart';
...
class WebApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return const ProviderScope(child: _MyWebApp());
  }
}
