                      ...
                      if (selectedBookingId != null) {
                        try {
                          selectedBooking = bookings
                              .firstWhere((b) => b.id == selectedBookingId);
                        } catch (e) {
                          selectedBooking =
          ...
          child: SfCalendar(
            scheduleViewMonthHeaderBuilder:
              ...
              return GlassmorphicContainer(
                ...
                borderRadius: 20,
                alignment: Alignment.center, blur: 10,
            ...
            appointmentBuilder:
              ...
              final isUpcoming = currentTime.isAfter(booking.timeRange.start
                      .subtract(const Duration(minutes: 10))) &&
                  currentTime.isBefore(booking.timeRange.start);
              final isLive = currentTime.isAfter(booking.timeRange.start) &&
                  currentTime.isBefore(booking.timeRange.end);
              final isPast = details.date
