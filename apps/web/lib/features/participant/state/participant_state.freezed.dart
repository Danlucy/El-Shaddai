...
mixin _$ParticipantState {
 ...
 String? get userId; String? get bookingId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ParticipantState&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.bookingId, bookingId) || other.bookingId == bookingId));
}
...
/// Create a copy of ParticipantState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = freezed,Object? bookingId = freezed,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ParticipantState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ParticipantState value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ParticipantState value)?  $default,){
final _that = this;
switch (_that) {
case _ParticipantState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? userId,  String? bookingId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ParticipantState() when $default != null:
return $default(_that.userId,_that.bookingId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? userId,  String? bookingId)  $default,) {final _that = this;
switch (_that) {
case _ParticipantState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? userId,  String? bookingId)?  $default,) {final _that = this;
switch (_that) {
case _ParticipantState() when $default != null:
return $default(_that.userId,_that.bookingId);case _:
  return null;
...
@override
Map<String, dynamic> toJson() {
  return _$ParticipantStateToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ParticipantState&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.bookingId, bookingId) || other.bookingId == bookingId));
}
...
/// Create a copy of ParticipantState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = freezed,Object? bookingId = freezed,}) {
